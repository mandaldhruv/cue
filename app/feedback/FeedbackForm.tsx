...
export default function FeedbackForm() {
  ...
  return <form className="feedback-form feedback-form-clean" onSubmit={submit}>
    ...
    <header className="feedback-clean-head"><span className="feedback-clean-icon feedback-message-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M5.5 5.75h13a2 2 0 0 1 2 2v7.5a2 2 0 0 1-2 2h-7.2l-4.8 3v-3h-1a2 2 0 0 1-2-2v-7.5a2 2 0 0 1 2-2Z"/><path d="M7.5 9.5h9M7.5 13.25h6"/></svg></span><div><h2>Share your feedback</h2><p>It only takes a minute and helps us improve Cue for you.</p></div></header>
