...
export default function PyqLibrary({ subjectSlug, compact = false }: { subjectSlug?: string; compact?: boolean }) {
  ...
  const [preview, setPreview] = useState<{ blob: Blob; paper: PublicPaper } | null>(null);
